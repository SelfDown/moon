...
const TableNameDbdataExport = "dbdata_export"
...
// TableName DbdataExport's table name
func (*DbdataExport) TableName() string {
	return TableNameDbdataExport
}

func (*DbdataExport) PrimaryKey() []string {
	return []string{"dbdata_export_id"}
}