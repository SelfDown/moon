...
const TableNameDeployTasklist88 = "deploy_tasklist_88"

// DeployTasklist88 mapped from table <deploy_tasklist_88>
...
// TableName DeployTasklist88's table name
func (*DeployTasklist88) TableName() string {
	return TableNameDeployTasklist88
}

func (*DeployTasklist88) PrimaryKey() []string {
