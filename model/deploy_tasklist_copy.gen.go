...
const TableNameDeployTasklistCopy = "deploy_tasklist_copy"

// DeployTasklistCopy mapped from table <deploy_tasklist_copy>
type DeployTasklistCopy struct {
	DeployFlag                *string    `gorm:"column:deploy_flag" json:"deploy_flag"` // 部署是否完成\n0 部署未完成\n1 部署完成。
	...
	Notes                     string     `gorm:"column:notes;not null" json:"notes"`                // 备注
	...
	CheckWarStatusCode        *string    `gorm:"column:check_war_status_code" json:"check_war_status_code"` // check.war web状态\n值：存HTTP_code
...
// TableName DeployTasklistCopy's table name
func (*DeployTasklistCopy) TableName() string {
	return TableNameDeployTasklistCopy
}

func (*DeployTasklistCopy) PrimaryKey() []string {
