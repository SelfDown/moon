...
const TableNameMoongodEventExe = "moongod_event_exe"

// MoongodEventExe mapped from table <moongod_event_exe>
...
// TableName MoongodEventExe's table name
func (*MoongodEventExe) TableName() string {
	return TableNameMoongodEventExe
}

func (*MoongodEventExe) PrimaryKey() []string {
