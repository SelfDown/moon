...
const TableNameOpsConfigDetailCopy = "ops_config_detail_copy"

// OpsConfigDetailCopy mapped from table <ops_config_detail_copy>
type OpsConfigDetailCopy struct {
	...
	OpsConfigFileRelPath *string    `gorm:"column:ops_config_file_rel_path" json:"ops_config_file_rel_path"`          // 软件配置文件相对路径\n比如： jboss/standalone/configruation/standalone.xml
}

// TableName OpsConfigDetailCopy's table name
func (*OpsConfigDetailCopy) TableName() string {
	return TableNameOpsConfigDetailCopy
}

func (*OpsConfigDetailCopy) PrimaryKey() []string {
