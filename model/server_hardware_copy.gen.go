...
const TableNameServerHardwareCopy = "server_hardware_copy"

// ServerHardwareCopy mapped from table <server_hardware_copy>
...
// TableName ServerHardwareCopy's table name
func (*ServerHardwareCopy) TableName() string {
	return TableNameServerHardwareCopy
}

func (*ServerHardwareCopy) PrimaryKey() []string {
