...
const TableNameServerHardwareCopy2 = "server_hardware_copy2"

// ServerHardwareCopy2 mapped from table <server_hardware_copy2>
...
// TableName ServerHardwareCopy2's table name
func (*ServerHardwareCopy2) TableName() string {
	return TableNameServerHardwareCopy2
}

func (*ServerHardwareCopy2) PrimaryKey() []string {
