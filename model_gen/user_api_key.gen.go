...
func newUserAPIKey(db *gorm.DB, opts ...gen.DOOption) userAPIKey {
	...
	_userAPIKey.UserAPIKeyID = field.NewInt32(tableName, "user_api_key_id")
	_userAPIKey.UserID = field.NewString(tableName, "user_id")
	_userAPIKey.APIKeyID = field.NewInt32(tableName, "api_key_id")
	_userAPIKey.CreateTime = field.NewTime(tableName, "create_time")
	_userAPIKey.ModifyTime = field.NewTime(tableName, "modify_time")
	_userAPIKey.Comments = field.NewString(tableName, "comments")
...
func (u *userAPIKey) updateTableName(table string) *userAPIKey {
	...
	u.UserAPIKeyID = field.NewInt32(table, "user_api_key_id")
	u.UserID = field.NewString(table, "user_id")
	u.APIKeyID = field.NewInt32(table, "api_key_id")
...
func (u *userAPIKey) fillFieldMap() {
	...
	u.fieldMap["user_api_key_id"] = u.UserAPIKeyID
	u.fieldMap["user_id"] = u.UserID
	u.fieldMap["api_key_id"] = u.APIKeyID
...
func (u userAPIKeyDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IUserAPIKeyDo {
