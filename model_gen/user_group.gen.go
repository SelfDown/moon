...
func newUserGroup(db *gorm.DB, opts ...gen.DOOption) userGroup {
	...
	_userGroup.UserGroupID = field.NewString(tableName, "user_group_id")
	_userGroup.CreateTime = field.NewTime(tableName, "create_time")
	_userGroup.ModifyTime = field.NewTime(tableName, "modify_time")
	_userGroup.Comments = field.NewString(tableName, "comments")
	_userGroup.UserGroupName = field.NewString(tableName, "user_group_name")
...
func (u *userGroup) updateTableName(table string) *userGroup {
	...
	u.UserGroupName = field.NewString(table, "user_group_name")
...
func (u *userGroup) fillFieldMap() {
	...
	u.fieldMap["user_group_name"] = u.UserGroupName
}
