...
func newUserTag(db *gorm.DB, opts ...gen.DOOption) userTag {
	...
	_userTag.UserTagID = field.NewString(tableName, "user_tag_id")
	_userTag.Username = field.NewString(tableName, "username")
...
func (u *userTag) updateTableName(table string) *userTag {
	...
	u.UserTagID = field.NewString(table, "user_tag_id")
...
func (u *userTag) fillFieldMap() {
	...
	u.fieldMap["user_tag_id"] = u.UserTagID
...
func (u userTagDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IUserTagDo {
